...
function UF:PostUpdateHealthColor(unit, r, g, b)
	...
	if ((colors.healthclass and colors.colorhealthbyvalue) or (colors.colorhealthbyvalue and parent.isForced) or (colors.custom_npc_health and not UnitIsPlayer(unit))) and not isTapped then
