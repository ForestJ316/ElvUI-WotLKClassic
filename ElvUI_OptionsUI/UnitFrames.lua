...
Colors.healthGroup.args.custom_npc_health = ACH:Toggle(L["Custom NPC Health"], L["Use custom health color for NPCs."], 11)
Colors.healthGroup.args.spacer1 = ACH:Spacer(20)
...
Colors.healthGroup.args.npc_health_pick = ACH:Color(L["NPC Health"], nil, 24, nil, nil, nil, nil, function() return not E.db.unitframe.colors.custom_npc_health end)
