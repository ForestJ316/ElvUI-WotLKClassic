...
L["You still have ElvUI_Config installed. ElvUI_Config has been renamed to ElvUI_Options, please remove it."] = "У Вас все еще стоит ElvUI_Config. Кое-кто переименовал его в ElvUI_Options, удалите папку со старым именем."
